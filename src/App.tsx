      ...
      <div className=' bg-[#071624] text-gray-50 relative overflow-hidden'>
        ...
        <Reveal>
          <main className='relative z-20 h-screen flex flex-col'>
            <div className="animate-pulse absolute top-[20%] left-[15%] rounded-full shadow-[0_0_250px_90px] shadow-yellow-200"/>
            <div className="animate-pulse absolute bottom-[30%] right-[15%] rounded-full shadow-[0_0_250px_60px] shadow-yellow-200"/>
              <Navbar/> 
            <div className='px-10 sm:px-20 my-auto space-y-4'>
              ...
              <h3 className='text-gray-400 text-lg font-mono font-medium'>Trade, earn, and own crypto on the all-in-one multi-chain DEX</h3>
                <div className='pt-8 sm:space-x-8 sm:block flex flex-col items-center gap-6'>
                  <button className="px-4 py-2 bg-gradient-to-br from-yellow-400 to-yellow-200 text-gray-800 rounded-full font-bold text-sm hover:from-yellow-500 hover:to-yellow-300  transition-all duration-500 ">Connect Wallet</button>
        ...
        <div className='px-6 sm:px-16 mt-4 md:mt-40'>
          <section className='space-y-14'>
            ...
            <div className='relative px-3 sm:px-10 pt-8 pb-12 rounded-2xl bg-gray-900'>
              <div className="animate-pulse absolute bottom-[5%] left-[40%] rounded-full shadow-[0_0_300px_60px] shadow-yellow-200"/>
          ...
          <div className="animate-pulse absolute bottom-[5%] left-[0%] rounded-full shadow-[0_0_300px_60px] shadow-yellow-200"/>
          <div className="animate-pulse absolute top-[30%] right-[0%] rounded-full shadow-[0_0_300px_60px] shadow-yellow-200"/>
              ...
              <main className=''>
                {
                  faqList.map(({id,query,solution})=>(
                    <Reveal key={id}>
                      <div onClick={()=>handleFAQList(id)} className='flex items-center justify-between gap-6 px-4 sm:px-10 lg:px-20 py-6 border-y border-gray-800 cursor-pointer'>
